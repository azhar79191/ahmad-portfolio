              ...
              <div className="flip-card h-72 w-full cursor-pointer">
                <div className="flip-card-inner">
                  <div className="flip-card-front relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col overflow-hidden">
                    <div className="absolute top-0 left-0 right-0 h-0.5" style={{ background: `linear-gradient(to right, ${s.gradient_from}, ${s.gradient_to})` }} />
                    <span className="absolute top-4 right-4 text-xs font-bold text-gray-700">0{i + 1}</span>
                    <div className="w-14 h-14 rounded-xl mb-5 shadow-lg float-anim" style={{ background: `linear-gradient(135deg, ${s.gradient_from}, ${s.gradient_to})`, animationDelay: `${i * 0.4}s` }} />
                  ...
                  <div className="flip-card-back relative rounded-2xl p-6 flex flex-col justify-between overflow-hidden" style={{ background: `linear-gradient(135deg, ${s.gradient_from}, ${s.gradient_to})` }}>
