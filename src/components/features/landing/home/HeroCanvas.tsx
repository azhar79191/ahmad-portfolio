...
function canUseWebGL() {
  try {
    ...
    canvas.addEventListener("webglcontextcreationerror", (e) => { (e as any).__failed = true; }, { once: true });
...
export default function HeroCanvas() {
  ...
  if (noWebGL) return (
    <div className="w-full h-full flex items-center justify-center">
      <div className="w-64 h-64 rounded-full bg-gradient-to-br from-violet-600 to-cyan-500 opacity-20 animate-pulse" />
    </div>
  );
